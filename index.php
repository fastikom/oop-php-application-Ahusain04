...
<html>
    <head>
        ...
        <title>Alumni TKJ angkatan 2014</title>
    ...
    <body>
        <div id="container">
            ...
            <div id="konten">
            <fieldset><legend>Daftar Alumni TKJ angkatan 2014 SMKN1 Wonosobo</legend>
                <form method="post" action="">
                    <input type="text" name="cari" size="50">
                    <input type="submit" name="caridata" value="Cari Alumni" >
                </form>
                <br>
                ...
                jumlah data ditemukan sebanyak : <?php echo mysql_num_rows($carinya); ?>
                    ...
                    if (isset($_GET['aksi'])) {
                        if ($_GET['aksi'] == "edit") {
                            ...
                            <form action="" method="POST">
                                ...
                                <table border="0" cellspacing="0" cellpadding="5" width="100%">
                                    ...
                                    <tr>
                                        <td>Pekerjaan</td>
                                        <td>:</td>
                                        <td><input type="text" name="pekerjaan" value="<?php echo $edit['pekerjaan']; ?>" size="50" ></td>
                                    </tr>
                                    <tr>
                                        <td>Telepon</td>
                                        <td>:</td>
                            ...
                            $telpon = $_POST['telpon'];
                            $dt->prosesedit($id, $nama, $alamat, $pekerjaan, $telpon);
                        }
                    }
                    ?>
                    ...
                    if (isset($_POST['simpan'])) {
                        ...
                        $pekerjaan = $_POST['pekerjaan'];
                        $telpon = $_POST['telpon'];
                        $dt->tambahdata($nama, $alamat, $pekerjaan, $telpon);
                    }
                    ?>
                    <form action="" method="POST">
                        <table border="0" cellspacing="0" cellpadding="5" width="100%">
